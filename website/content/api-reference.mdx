...
| ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@haustle/notion-orm/notion/db/<databaseName>`  | `<databaseName>(auth)` factory, `DatabaseSchemaType`, `QuerySchemaType`, generated Zod schema, generated option tuples (for select/status/multi-select), schema/type aliases |
| `@haustle/notion-orm/notion/agents/<agentName>` | `<agentName>(auth)` factory that returns an `AgentClient`                                                                                                                    |
| `@haustle/notion-orm/notion/db`                 | `databases` barrel object (all database factories)                                                                                                                           |
