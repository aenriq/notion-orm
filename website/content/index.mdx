export const metadata = {
  ...
  title: "Overview",
  description:
    "A Notion API TypeScript wrapper that aims to improve interactions with databases and agents by building local static schemas.",
};
...
A [Notion API](https://developers.notion.com/) TypeScript wrapper that leverages static types to deliver a better database (and custom agents) experience
